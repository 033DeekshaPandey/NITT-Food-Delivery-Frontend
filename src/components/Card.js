      ...
      <div style={{ width: "17rem", maxHeight: "500px" }}>
        ...
        {userRole === "vendor" ? (
          <div className="d-flex justify-center mt-2">
            <button className="m-2 mybtn" onClick={handleEditClick}>
              Edit ✏️
            </button>
            <button className="m-2 mybtn" onClick={handleDeleteClick}>
              Delete 🗑️
            </button>
          </div>
        ) : (
          localStorage.getItem("authToken") && (
              <button className="justify-center ms-2 mybtn" onClick={handleAddToCart}>
                Add to Cart
              </button>
          )
        )}
